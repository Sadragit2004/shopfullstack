...
from apps.product.api.serializers.product_gallery.serializers import (
    ProductGallerySerializer,
)
from apps.core.api.response import success_response


class ProductGalleryListCreateView(ListCreateAPIView):
...
class ProductGalleryDetailView(RetrieveUpdateDestroyAPIView):
