...
from apps.product.api.serializers.sale_type.serializers import (
    SaleTypeSerializer,
)
from apps.product.models.sale_type import SaleType


class SaleTypeListCreateView(ListCreateAPIView):
...
class SaleTypeDetailView(RetrieveUpdateDestroyAPIView):
    queryset = SaleType.objects.all()
    serializer_class = SaleTypeSerializer
